                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table text-center m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="height-50" src="{{asset('app-assets/img/elements/01.png') }}" alt="Generic placeholder image" /></td>
                                                    <td>Espresso</td>
                                                    <td>1</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img class="height-50" src="{{asset('app-assets/img/elements/15.png') }}" alt="Generic placeholder image" /></td>
                                                    <td>iPhone</td>
                                                    <td>2</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img class="height-50" src="{{asset('app-assets/img/elements/11.png') }}" alt="Generic placeholder image" /></td>
                                                    <td>iMac</td>
                                                    <td>1</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img class="height-50" src="{{asset('app-assets/img/elements/14.png') }}" alt="Generic placeholder image" /></td>
                                                    <td>iWatch</td>
                                                    <td>2</td>
                                                    <td>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media pt-0 pb-2">
                                        <img class="mr-3 avatar" src="{{asset('app-assets/img/portrait/small/avatar-s-12.png') }}" alt="Avatar" width="35">
                                    ...
                                    <div class="media py-2">
                                        <img class="mr-3 avatar" src="{{asset('app-assets/img/portrait/small/avatar-s-11.png') }}" alt="Avatar" width="35">
                                        <div class="media-body">
                                    ...
                                    <div class="media py-2">
                                        <img class="mr-3 avatar" src="{{asset('app-assets/img/portrait/small/avatar-s-3.png') }}" alt="Avatar" width="35">
                                        <div class="media-body">
                                    ...
                                    <div class="media py-2">
                                        <img class="mr-3 avatar" src="{{asset('app-assets/img/portrait/small/avatar-s-22.png') }}" alt="Avatar" width="35">
                                        <div class="media-body">
                                    ...
                                    <div class="media py-2">
                                        <img class="mr-3 avatar" src="{{asset('app-assets/img/portrait/small/avatar-s-18.png') }}" alt="Avatar" width="35">
                                        <div class="media-body">
                                    ...
                                    <div class="media py-2">
                                        <img class="mr-3 avatar" src="{{asset('app-assets/img/portrait/small/avatar-s-21.png') }}" alt="Avatar" width="35">
                                        <div class="media-body">
